...
WebUI.setText(findTestObject('Object Practice Form/Input Text', [('id') : 'firstName']), 'Laundry')

WebUI.setText(findTestObject('Object Practice Form/Input Text', [('id') : 'lastName']), 'Simulator')

WebUI.setText(findTestObject('Object Practice Form/Input Text', [('id') : 'userEmail']), 'anomalilaundry')
